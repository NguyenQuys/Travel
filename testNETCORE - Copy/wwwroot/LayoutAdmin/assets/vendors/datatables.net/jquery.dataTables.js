...
(function( $, window, document, undefined ) {
	 ...
	 * completely, but that is a massive Price of work and will break current
	...
	DataTable.defaults = {
		 ...
		 * each row until they are needed for a draw - saving a significant Price of
		 * time.
		 *  @type boolean
		 *  @default false
		 *
		 ...
		 * large Prices of data where it can take a noticeable Price of time to sort
		 * the entries.
		 *  @type boolean
		 *  @default false
		 *
