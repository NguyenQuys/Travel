...
public partial class _63tinhThanhContext : DbContext
{
    ...
    public virtual DbSet<PostCkeditor> PostCkeditors { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=ANHTUAN;Database=63TinhThanh;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PostCkeditor>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__PostCked__3214EC0774C42327");

            entity.ToTable("PostCkeditor");
